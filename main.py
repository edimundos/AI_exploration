...
class API2DExplorer:
    ...
    def plot_exploration(self, filename: str = "exploration_results.png") -> None:
    ...
    def plot_exploitation(self, filename: str = "exploitation_path.png") -> None:
    ...
    def run(self) -> None:
        ...
        self.explore()
        self.save_csv(Path("explore_results.csv"), [(x, y, z) for (x, y), z in zip(self.X, self.y)])

        self.plot_exploration()

        self.beam_search()
        self.save_csv(Path("exploit_results.csv"), self.exploitation_path)
